...
/*  <div className="col">
          <div className="card border-0 rounded-0 ">
            ...
            <h3 className="card-title heading-s">Jake Richards</h3>
            <p className="card-text body">Chief Architect</p>
          </div>
        </div>
        <div className="col">
          <div className="card border-0 rounded-0">
            ...
            <h3 className="card-title heading-s">Thompson Smith</h3>
            <p className="card-text body">Head of Finance</p>
          </div>
        </div>
        <div className="col">
          <div className="card border-0 rounded-0">
            <img
              ...
              className="card-img-top rounded-0"
            />
            <h3 className="card-title heading-s">Jackson Rourke</h3>
            <p className="card-text body">Lead Designer</p>
          </div>
        </div>
         <div className="col">
          <div className="card border-0 rounded-0 img-box">
            <img
              ...
              className="card-img-top rounded-0 leader-img"
            />
            <h3 className="card-title heading-s">Maria Simpson</h3>
            <p className="card-text body">Senior Architect</p>
            <div className="hover-links">
              <a href="https://www.linkedin.com" className="body">
