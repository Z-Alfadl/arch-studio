...
//MOST RECENT
/* FOOTER MAY NEED REWORKING
  Current link button overlaps with the footer-nav-container at awkward viewport widths
  figure out how to shrink the footer-nav-container at smaller viewport widths
  WELCOME SECTION on large viewport needs correction
  then move on to other pages
*/
...
/*<footer className="position-relative">
      <div className="d-flex flex-column flex-lg-row align-items-center grey-back">
        <div className="footer-logo d-flex flex-wrap align-items-center justify">
          <svg xmlns="http://www.w3.org/2000/svg" width="97" height="40" className="mx-auto">
            <path
              fill="#ffffff"
        ...
        <nav>
          <ul className="p-0 d-flex flex-column flex-lg-row navigation justify-content-around">
      ...
      <div className="position-absolute offset">
        <LinkButton
          to={"portfolio"}
...
//ORIGINAL
/*<footer className="position-relative">
      <div className="d-flex align-items-center grey-back">
        <div className="footer-logo d-flex flex-wrap align-items-center justify">
          <svg xmlns="http://www.w3.org/2000/svg" width="97" height="40" className="mx-auto">
            <path
              fill="#ffffff"
        ...
        <nav>
          <ul className="d-flex flex-row navigation">
